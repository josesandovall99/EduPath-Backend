module.exports = (sequelize, DataTypes) => {
  const Ejercicio = sequelize.define('Ejercicio', {
    ...
    tipo_ejercicio: {
      type: DataTypes.ENUM('Compilador', 'Diagramas UML', 'Preguntas', 'Opción única', 'Ordenar', 'Relacionar', 'Simulación GP'),
      allowNull: false,
    ...
    configuracion: {
      // Estructura dinámica para preguntas/respuestas por asignatura
      // Compilador: {
      //   tipo: 'programacion',
      ...
      // Simulación GP: { tipo: 'simulacion-gp', variante: 'mapa_poder'|'edt', spec: { ... } }
