...
async function enviarCorreoBienvenidaAdministrador(administrador) {
  ...
  return transporter.sendMail({
    ...
    subject: 'Bienvenido a EduPath - Cuenta de Administrador',
    html: `
<!DOCTYPE html>
<html lang="es">
<head>
        ...
        <table width="600" cellpadding="0" cellspacing="0" style="background-color:#ffffff;border-radius:8px;overflow:hidden;box-shadow:0 2px 8px rgba(0,0,0,0.1);max-width:600px;width:100%;">
          ...
          <tr>
            <td style="padding:36px 40px 20px;">
              <h2 style="margin:0 0 12px;color:#1a1a2e;font-size:20px;">¡Bienvenido, ${administrador.nombre}!</h2>
              <p style="margin:0 0 12px;color:#444;font-size:15px;line-height:1.6;">
                Nos complace informarte que se ha creado una cuenta de <strong>Administrador</strong> a tu nombre en <strong>EduPath</strong>, la plataforma educativa de la Universidad de Santander para el programa de Ingeniería de Sistemas.
              </p>
              <p style="margin:0 0 24px;color:#444;font-size:15px;line-height:1.6;">
                Como administrador tendrás acceso completo al sistema: gestión de usuarios, contenidos académicos, rutas de aprendizaje y configuración general de la plataforma.
              </p>
              ...
              <table width="100%" cellpadding="0" cellspacing="0" style="border:1px solid #e0e0e0;border-radius:6px;overflow:hidden;margin-bottom:24px;">
                <tr style="background-color:#f8f9fa;">
                  <td style="padding:12px 16px;color:#555;font-size:14px;border-bottom:1px solid #e0e0e0;width:45%;">Código de Administrador</td>
                  <td style="padding:12px 16px;color:#1a1a2e;font-size:14px;font-weight:700;border-bottom:1px solid #e0e0e0;">${administrador.codigoAcceso}</td>
                </tr>
                <tr>
                  <td style="padding:12px 16px;color:#555;font-size:14px;border-bottom:1px solid #e0e0e0;">Contraseña inicial</td>
                  <td style="padding:12px 16px;color:#1a1a2e;font-size:14px;font-weight:700;border-bottom:1px solid #e0e0e0;">${administrador.password}</td>
                </tr>
                <tr style="background-color:#f8f9fa;">
                  <td style="padding:12px 16px;color:#555;font-size:14px;">Correo electrónico</td>
                  <td style="padding:12px 16px;color:#1a73e8;font-size:14px;">${administrador.email}</td>
                </tr>
              </table>
              ...
              <p style="margin:0 0 6px;color:#444;font-size:14px;line-height:1.6;">
                En caso de presentar alguna duda o requerir asistencia adicional, puedes comunicarte con el equipo de soporte técnico.
              </p>
            </td>
          </tr>
